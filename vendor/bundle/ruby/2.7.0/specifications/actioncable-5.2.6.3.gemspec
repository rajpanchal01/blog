# -*- encoding: utf-8 -*-
# stub: actioncable 5.2.6.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.2.6.3/actioncable/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.2.6.3/actioncable" } if s.respond_to? :metadata=
